            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center justify-center mt-2">
                ...
                <a href="https://www.instagram.com/bonaevents_/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-teal-500 transition-colors">
                  {t('footer.followInstagram', 'Seguici su Instagram')}: @bonaevents_
                </a>
              </li>
            </ul>
            <p className="text-gray-400 mt-4 max-w-md mx-auto">
              {t('footer.description', 'Saranda: un piccolo paradiso sulla costa ionica dell\'Albania, famosa per le sue acque cristalline, spiagge dorate e la vicinanza a siti storici come Butrinto, patrimonio UNESCO.')}
            </p>
          </div>
        </div>
